...
HiddenServiceDir /var/lib/tor/hidden_room/
HiddenServicePort 80 ${__PROD_HOSTNAME__}:${__PROD_PORT__}
...
fs.writeFile('docker-compose.yaml', 
    compose, 
    (err)=> {
        if (err) return console.log(err);
